一个简单的创建自定义Play资源的插件,[Default Playables](https://assetstore.unity.com/packages/essentials/default-playables-95266#description) 由官方出品,一键生成你想要的类型和对应的behavior脚本,asset等,
